...
export default function Auth() {
  ...
  const handleLogin = async () => {
    try {
      const res = await fetch("https://hackathon-digitalflake.onrender.com/api/auth/login", {
        method: "POST",
  ...
  const handleSignup = async () => {
    try {
      const res = await fetch("https://hackathon-digitalflake.onrender.com/api/auth/signup", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
